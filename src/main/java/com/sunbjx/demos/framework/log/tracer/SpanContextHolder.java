...
/**
 * Utility for managing the thread local state for the {@link Tracer}.
 *
 * @author Spencer Gibb
 * @author Dave Syer
 */
class SpanContextHolder {
	...
	private static final Log log          = org.apache.commons.logging.LogFactory.getLog(SpanContextHolder.class);
