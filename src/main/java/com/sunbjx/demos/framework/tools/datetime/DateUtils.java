...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    /**
     * 将某一天的时间设置为 23：59：59秒
     */
    public static Date setCurDateMaxTimes(Date date) {
     ...
     * 清除 时分秒 的field
     */
    public static Date clearHourEndFiled(Date date) {
     ...
     * 清除 分秒的field
     */
    public static Date clearMinutesEndFiled(Date date) {
        date = DateUtils.setMinutes(date, 0);
        date = DateUtils.setSeconds(date, 0);
        date = DateUtils.setMilliseconds(date, 0);
        return date;
     ...
     * 清除 秒的field
     */
    public static Date clearSecondEndFiled(Date date) {
        date = DateUtils.setSeconds(date, 0);
        date = DateUtils.setMilliseconds(date, 0);
        return date;
    }
    ...
    public static long compare(Date data1, Date date2) {
        long index = data1.getTime() - date2.getTime();
        return index;
    }
