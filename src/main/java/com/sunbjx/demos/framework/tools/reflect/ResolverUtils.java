...
import com.sunbjx.demos.framework.tools.reflect.vfs.VFS;
 ...
 * {@link #(org.apache.ibatis.io.ResolverUtil.Test, String)} ()} method and supplying
...
public class ResolverUtils<T> {
     ...
     */
    private static final Log log = LogFactory.getLog(ResolverUtils.class);
     ...
     */
    public ResolverUtils<T> findImplementations(Class<?> parent, String... packageNames) {
     ...
     * @param packageNames one or more package names to scan (including subpackages) for classes
     */
    public ResolverUtils<T> findAnnotated(Class<? extends Annotation> annotation, String... packageNames) {
        if (packageNames == null) {
            return this;
        }
     ...
     */
    public ResolverUtils<T> find(Test test, String packageName) {
